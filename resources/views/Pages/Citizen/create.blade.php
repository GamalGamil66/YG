                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="state_of_house" class="form-control">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="no_of_females" class="form-control">
                                    @error('no_of_females')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col">
                                    ...
                                    <input type="text" name="no_of_males" class="form-control">
                                    @error('no_of_males')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
